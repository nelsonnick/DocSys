...
class EditFrom extends React.Component {
  ...
  render() {
    ...
    const { flowId, fileNumber, personName, personNumber, departmentName, flowReason, flowDirect, flowType, flowRemark, flowFlow } = this.props;
